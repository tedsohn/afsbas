		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zsmzgrcstatus-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsmzgrcstatus-display": {
								"semanticObject": "zsmzgrcstatus",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsmzgrcstatus",
									"url": sap.ui.require.toUrl("zsmzgrcstatus")
								}
							}
						}
					}
